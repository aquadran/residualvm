...
static const PlainGameDescriptor icbGames[] = {{"icb", "In Cold Blood"}, {0, 0}};

static const ADGameDescription gameDescriptions[] = {
    // In Cold Blood
    // English GOG Version
    {"icb", "GOG", {{"engine.exe", 0, "0c4a7a5046ec13ccac89ab3f959cc217", 837632}, {NULL, 0, NULL, 0}}, Common::EN_ANY, Common::kPlatformWindows, ADGF_NO_FLAGS, GUIO_NONE},

    // In Cold Blood
    // English Demo
    {"icb",
     "Demo",
     {{"", 0, "", 0}, // TODO: Fill with correct values
      {NULL, 0, NULL, 0}},
     Common::EN_ANY,
